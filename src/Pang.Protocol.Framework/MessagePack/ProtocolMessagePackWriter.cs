...
using System.Text;
using Pang.Protocol.Framework.BaseTypes;
using Pang.Protocol.Framework.Buffers;
using Pang.Protocol.Framework.Extensions;

namespace Pang.Protocol.Framework.MessagePack;

/// <summary>
/// 消息写入器
/// </summary>
public ref partial struct ProtocolMessagePackWriter
{
    private ProtocolBufferWriter _writer;

    /// <summary>
    /// </summary>
    /// <param name="buffer"> 内存块 </param>
    public ProtocolMessagePackWriter(Span<byte> buffer)
    {
        _writer = new ProtocolBufferWriter(buffer);
    }
    ...
    ///// 写入头标识
    ///// </summary>
    //public void WriteStart() => WriteByte();
